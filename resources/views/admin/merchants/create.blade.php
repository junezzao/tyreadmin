...
@section('title')
	@lang('admin/page-titles.page_title_merchant_create')
@stop
	        ...
	        <div class="col-xs-12">
	          	<div class="box">
	            	<div class="box-header">
	              		<h3 class="box-title">@lang('admin/page-titles.box_header_merchant_create')</h3>
	            	</div>
	            	<div class="box-body">
	            		{!! Form::open(['route' => 'admin.merchants.store','files'=>true]) !!}
	            		  <div class="col-sm-6">
							  ...
							  <div class="form-group row">
							    {!! Form::label('logo','Logo',['class'=>'col-sm-4 control-label']) !!}
							    <div class="col-sm-8">
						...
						<div class="col-sm-6">
							  ...
							  <div class="form-group row">
							    {!! Form::label('supported_currencies','Supported Currencies',['class'=>'col-sm-4 control-label']) !!}
							    <div class="col-sm-5">
							     <span class="text-danger">{{ $errors -> first('currencies')}}</span>
							     <?php echo Form::select('currencies[0]', $currencies_arr, null, ['class'=>'form-control select2','placeholder' => 'Supported Currency&hellip;']); ?>
							     <span class="text-danger">{{ $errors -> first('currencies.0')}}</span>
							    </div>
							    <div class="col-sm-3">
							     <span class="text-danger">{{ $errors -> first('rate')}}</span>
							     <?php echo Form::text('rate[0]',  null, ['class'=>'form-control','placeholder' => 'Rate']); ?>
						...
						<div class="col-sm-12">
							<div class="col-sm-12">
								<div class="form-group row pull-right">
									<button type="submit" class="btn btn-default">Create New Merchant</button>
								</div>
							</div>
						</div>
						{!! Form::close() !!}
