...
@section('title')
	@lang('admin/page-titles.page_title_supplier_create')
@stop
	        ...
	        <div class="col-xs-12">
	          	<div class="box">
	            	<div class="box-header">
	              		<h3 class="box-title">@lang('admin/page-titles.box_header_supplier_create')</h3>
	            	</div>
	            	<div class="box-body">
	            		{!! Form::open(['route' => 'admin.suppliers.store','files'=>false]) !!}
	            		  <div class="col-sm-10">
							  ...
							  <div class="col-sm-12">
									<div class="col-sm-12">
										<div class="form-group row pull-right">
											<button type="submit" class="btn btn-default">Create Supplier</button>
										</div>
									</div>
								</div>							  
						</div>
