	        ...
	        <div class="col-xs-12">
	          	<div class="box">
	            	<div class="box-header">
	              		<h3 class="box-title">@lang('admin/user.box_header_role_edit')</h3>
	            	</div><!-- /.box-header -->
	            	<div class="box-body">
	            		<!-- Nav tabs -->
                        <div class="nav-tabs-custom">
                            ...
                            <!-- Tab panes -->
                            {!! Form::open(array('id' => 'edit_role_form', 'url' => route('admin.roles.update', $role->id), 'method' => 'PUT')) !!}
                                    ...
                                    <div class="col-xs-12">
                                    	<div class="col-xs-8">
	                                    	<div class="form-group">
					            				...
					            				<div class="col-xs-9">
			   										{!! Form::text( 'name', $role->name, ['class' => 'form-control', 'placeholder' => trans('admin/user.role_form_label_name'), 'disabled'] ) !!}
								            ...
								            <div class="form-group">
					            				...
					            				<div class="col-xs-9">
			   										{!! Form::text( 'slug', $role->slug, ['class' => 'form-control', 'placeholder' => trans('admin/user.role_form_label_slug'), 'disabled'] ) !!}
								            ...
								            <div class="form-group">
					            				...
					            				<div class="col-xs-3">
			   										{!! Form::number( 'level', $role->level, ['class' => 'form-control', 'min' => 1, 'max' => (Auth::user()->level() - 1), 'placeholder' => trans('admin/user.role_form_label_level')] ) !!}
								            ...
								            <div class="form-group">
					            				...
					            				<div class="col-xs-3">
					            					{!! Form::select('status', $statuses, $role->status, array('class' => 'form-control select2-nosearch')) !!}
								            ...
								            <div class="form-group">
					            				...
					            				<div class="col-xs-9">
			   										{!! Form::text( 'description', $role->description, ['class' => 'form-control', 'placeholder' => trans('admin/user.role_form_label_description')] ) !!}
													      	...
													      	@foreach($permissionItems as $p)
													      		...
													      		<div class="col-xs-3">
													      			<div class="onoffswitch">
														      			<input type="checkbox" name="permission_ids[]" value="{{ $p['id'] }}" class="onoffswitch-checkbox" id="js-permission-id-{{ $p['id'] }}" {{ (in_array($p['id'], $role_permissions)) ? 'checked' : '' }}>
                            ...
                            <div class="col-xs-12">
				         		<div class="form-group pull-right">
					            	<button type="submit" class="btn btn-default">@lang('admin/user.button_update_role')</button>
					            </div>
					        </div>
                            {!! Form::close() !!}
                        </div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('select[name=status]').on('change', function (e) {
			if ($(this).val() == 'Inactive' && roleStatus == 'Active') {
	        	if (!confirm('Deactivating a role will deactivate all users of that role. Reactivating the role will NOT reactivate the users. Are you sure you want to deactivate this role?')) {
	    ...
	    $('#edit_role_form').submit(function() {
	    	if ($('select[name=status]').val() == 'Inactive' && roleStatus == 'Active') {
	    		if (confirm('\n**Double Confirmation!!**\n\nDeactivating a role will deactivate all users of that role. Reactivating the role will NOT reactivate the users. Are you sure you want to deactivate this role?')) {
	    			return true;
	    		}
	    		else {
