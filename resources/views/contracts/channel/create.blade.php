...
@section('title')
	@lang('contracts.page_title_channel_contracts_create')
@stop
	        ...
	        <div class="col-xs-12">
	          	<div class="box">
	            	<div class="box-header">
	              		<h3 class="box-title">@lang('contracts.box_header_channel_contracts_create')</h3>
	            	</div><!-- /.box-header -->
	            	<div class="box-body contracts-module contract-create-page">
	            		{!! Form::open(array('url' => route('contracts.channels.store'), 'method' => 'POST', 'id' => 'create-contract-form')) !!}
		            		...
		            		<div class="row">
		            			<div class="form-group">
			            			...
			            			<div class="col-xs-5">
			            				{!! Form::select('channel', $channels, Input::old('channel'), array('class' => 'form-control select2', 'id' => 'channel_dropdown', 'placeholder' => trans('contracts.create_placeholder_fee_channel'))) !!}
		            		...
		            		<div class="row">
		            			<div class="form-group">
			            			...
			            			<div class="col-xs-5">
			            				{!! Form::select('merchant', Session::has('merchants') ? Session::get('merchants') : array(), Input::old('merchant'), array('class' => 'form-control select2', 'id' => 'merchant_dropdown', 'placeholder' => trans('contracts.create_placeholder_merchant'))) !!}
		            			...
		            			<div class="form-group">
			            			...
			            			<div class="col-xs-5">
			            				<div class="row radio">
			            					<label>
					            				<div class="col-xs-1">
					            					<input style="margin-left: -8px;" type="radio" name="guarantee-charge" value="1" checked>
					            				</div>
					            				<div class="col-xs-11" style="margin-left: 15px;">
			            				...
			            				<div class="row radio">
			            					<label>
					            				<div class="col-xs-1">
					            					<input style="margin-left: -8px;" type="radio" name="guarantee-charge" value="0">
					            				</div>
					            				<div class="col-xs-11" style="margin-left: 15px;">
