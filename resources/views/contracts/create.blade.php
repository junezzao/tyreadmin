...
@section('title')
	@lang('contracts.page_title_contracts_create')
@stop

@section('content')
	<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>@lang('contracts.content_header_contracts')</h1>
	        ...
	        <div class="col-xs-12">
	          	<div class="box">
	            	<div class="box-header">
	              		<h3 class="box-title">@lang('contracts.box_header_contracts_create')</h3>
	            	</div><!-- /.box-header -->
	            	<div class="box-body contracts-module contract-create-page">
	            		{!! Form::open(array('url' => route('contracts.store'), 'method' => 'POST', 'id' => 'create-contract-form')) !!}
		            		...
		            		<div class="row">
		            			<div class="form-group">
			            			...
			            			<div class="col-xs-5">
			            				{!! Form::text( 'name', null, ['class' => 'form-control', 'placeholder' => trans('contracts.create_placeholder_name')] ) !!}
		            		...
		            		<div class="row">
		            			<div class="form-group">
			            			...
			            			<div class="col-xs-5">
			            				{!! Form::select('merchant', $merchants, Input::old('merchant'), array('class' => 'form-control select2', 'id' => 'merchant_dropdown', 'placeholder' => trans('contracts.create_placeholder_merchant'))) !!}
		            		...
		            		<div class="row">
		            			<div class="form-group">
			            			...
			            			<div class="col-xs-5">
			            				{!! Form::select('brand', Session::has('brands') ? Session::get('brands') : array(), Input::old('brand'), array('class' => 'form-control select2', 'id' => 'brands_dropdown', 'placeholder' => trans('contracts.create_placeholder_brand'))) !!}
		            			...
		            			<div class="form-group">
			            			...
			            			<div class="col-xs-5">
			            				<div class="row radio">
			            					<label>
					            				<div class="col-xs-1">
					            					<input style="margin-left: -8px;" type="radio" name="minimum_guarantee" value="not_applicable" {{ ((!isset($old_inputs['minimum_guarantee']) || $old_inputs['minimum_guarantee'] == 'not_applicable')) ? 'checked' : '' }}>
					            				</div>
			            					...
			            					<div class="col-xs-12">
			            						<div class="input-group">
				            						<span class="input-group-addon">
				            							<input type="radio" name="minimum_guarantee" value="applicable" {{ ((isset($old_inputs['minimum_guarantee']) && $old_inputs['minimum_guarantee'] == 'applicable')) ? 'checked' : '' }}>
				            						</span>
				            						<input type="number" placeholder="@lang('contracts.create_placeholder_amount')" class="form-control" name="minimum_guarantee_amount" value="{{ Input::old('minimum_guarantee_amount') }}" id="minimum-guarantee" {{ ((isset($old_inputs['minimum_guarantee']) && $old_inputs['minimum_guarantee'] == 'applicable')) ? '' : 'disabled' }}>
				            						<span class="input-group-addon">$</span>
			            						</div>
				            					<div class="error">{{ $errors->first('minimum_guarantee_amount') }}</div>
			            					</div>
			            				</div>
			            				<div class="error">{{ $errors->first('minimum_guarantee') }}</div>
			            			</div>
			            		</div>
		            		</div>
		            		<div class="row">
		            			<div class="form-group">
			            			...
			            			<div class="col-xs-5">
			            				<div class="row radio">
			            					<label>
					            				<div class="col-xs-1">
					            					<input style="margin-left: -8px;" type="radio" name="guarantee-charge" value="0" {{(Input::old('guarantee-charge') == 0)?'checked':''}}>
					            				</div>
					            				<div class="col-xs-11" style="margin-left: 15px;">
			            				...
			            				<div class="row radio">
			            					<label>
					            				<div class="col-xs-1">
					            					<input style="margin-left: -8px;" type="radio" name="guarantee-charge" value="1" {{(Input::old('guarantee-charge') != 0)?'checked':''}}>
					            				</div>
					            				<div class="col-xs-11" style="margin-left: 15px;">
			            				...
			            				<div class="row">
			            					<div class="col-xs-6">
			            						<div class="input-group">
				            						...
				            						{!! Form::text( 'start_date', null, ['class' => 'form-control datepicker-input', 'placeholder' => trans('contracts.create_placeholder_start_date')] ) !!}
			            						</div>
			            					...
			            					<div class="col-xs-6">
			            						<div class="input-group">
				            						...
				            						{!! Form::text( 'end_date', null, ['class' => 'form-control datepicker-input', 'placeholder' => trans('contracts.create_placeholder_end_date')] ) !!}
			            						</div>
		            		...
		            		<div class="row">
		            			<div class="form-group">
			            			<div class="col-xs-2">
			            				<label class="control-label">@lang('contracts.return_fee')</label>
			            			</div>
			            			<div class="col-xs-5">
			            				<div class="row">
			            					<div class="col-xs-6">
			            						<div class="input-group">
				            						{!! Form::text( 'return_fee', null, ['class' => 'form-control', 'placeholder' => trans('contracts.create_placeholder_return_fee')] ) !!}
			            						</div>
			            						<div class="error">{{ $errors->first('return_fee') }}</div>
			            					</div>
			            				</div>
			            			</div>
			            		</div>
		            			...
		            			<div class="form-group">
			            			<div class="col-xs-2">
			            				<label class="control-label">@lang('contracts.shipped_fee')</label>
			            			</div>
			            			<div class="col-xs-5">
			            				<div class="row">
			            					<div class="col-xs-6">
			            						<div class="input-group">
				            						{!! Form::text( 'shipped_fee', null, ['class' => 'form-control', 'placeholder' => trans('contracts.create_placeholder_shipped_fee')] ) !!}
			            						</div>
			            						<div class="error">{{ $errors->first('shipped_fee') }}</div>
			            					</div>
			            				</div>
			            			</div>
			            		</div>
		            			...
		            			<div class="form-group">
			            			<div class="col-xs-2">
			            				<label class="control-label">@lang('contracts.storage_fee')</label>
			            			</div>
			            			<div class="col-xs-5">
			            				<div class="row">
			            					<div class="col-xs-6">
			            						<div class="input-group">
				            						{!! Form::text( 'storage_fee', null, ['class' => 'form-control', 'placeholder' => trans('contracts.create_placeholder_storage_fee')] ) !!}
			            						</div>
			            						<div class="error">{{ $errors->first('storage_fee') }}</div>
			            					</div>
			            				</div>
			            			</div>
			            		</div>
		            		...
		            		<div class="row">
		            			<div class="form-group">
			            			<div class="col-xs-2">
			            				<label class="control-label">@lang('contracts.inbound_fee')</label>
			            			</div>
			            			<div class="col-xs-5">
			            				<div class="row">
			            					<div class="col-xs-6">
			            						<div class="input-group">
				            						{!! Form::text( 'inbound_fee', null, ['class' => 'form-control', 'placeholder' => trans('contracts.create_placeholder_inbound_fee')] ) !!}
			            						</div>
			            						<div class="error">{{ $errors->first('inbound_fee') }}</div>
			            					</div>
			            				</div>
			            			</div>
			            		</div>
		            		...
		            		<div class="row">
		            			<div class="form-group">
			            			<div class="col-xs-2">
			            				<label class="control-label">@lang('contracts.outbound_fee')</label>
			            			</div>
			            			<div class="col-xs-5">
			            				<div class="row">
			            					<div class="col-xs-6">
			            						<div class="input-group">
				            						{!! Form::text( 'outbound_fee', null, ['class' => 'form-control', 'placeholder' => trans('contracts.create_placeholder_outbound_fee')] ) !!}
			            						</div>
			            						<div class="error">{{ $errors->first('outbound_fee') }}</div>
			            					</div>
			            				</div>
			            			</div>
			            		</div>
			            			...
			            			<div class="form-group">
				            			...
				            			<div class="col-xs-10 contract-fee-container">
				            				...
				            				@if(empty($old_inputs['fee-info']))
					            				<div class="contract-fee" data-index="0" id="contract-fee-0">
					            					<div class="row">
						            					<div class="col-xs-3">
						            						<div class="radio top-radio">
																<label>
																	<input type="radio" value="0" name="fee-info[0][fixed-charge]" checked>
						            					...
						            					<div class="col-xs-3">
						            						<div class="radio top-radio">
																<label>
																	<input type="radio" value="1" name="fee-info[0][fixed-charge]">
																	@lang('contracts.label_fixed_charge')
																</label>
															</div>
						            					</div>
					            						<button type="button" data-index="0" class="close contract-close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
						            				</div>
						            				<div class="row fee-options">
						            					{!! Form::select('fee-info[0][type]', $feeTypes, null, array('class' => 'form-control select2 type-dropdown', 'placeholder' => trans('contracts.create_placeholder_fee_type'), 'data-index' => 0)) !!}
						            					<div class="custom-textbox">
							            					<div class="input-group">
							            						<span class="input-group-addon type-symbol">%</span>
							            						{!! Form::input('number', 'fee-info[0][amount]', null, ['class' => 'form-control', 'placeholder' => trans('contracts.create_placeholder_amount')] ) !!}
							            					</div>
							            				</div>
						            					<span class="rule-label syntax-grammar"> of </span> 
						            					{!! Form::select('fee-info[0][base]', $feeBases, null, array('class' => 'form-control select2 base-dropdown', 'placeholder' => trans('contracts.create_placeholder_fee_base'), 'data-index' => 0)) !!}
						            					{!! Form::select('fee-info[0][operand]', $feeOperands, null, array('class' => 'form-control select2 operand-dropdown', 'placeholder' => trans('contracts.create_placeholder_fee_operand'), 'data-index' => 0)) !!}
						            					<div class="custom-textbox">
							            					<div class="input-group">
							            						<span class="input-group-addon">$</span>
						            							{!! Form::input('number', 'fee-info[0][min-amount]', null, ['class' => 'form-control min-amount', 'placeholder' => trans('contracts.create_placeholder_amount')] ) !!}
						            						</div>
						            					</div>
						            					...
						            					<div class="custom-textbox">
							            					<div class="input-group">
							            						<span class="input-group-addon">$</span>
						            							{!! Form::input('number', 'fee-info[0][max-amount]', null, ['class' => 'form-control max-amount', 'placeholder' => trans('contracts.create_placeholder_amount')] ) !!}
						            						</div>
						            					</div>
						            				</div>
				            						...
				            						<div class="row filters-row">
				            							<div class="col-xs-12">
				            								{!! Form::select('fee-info[0][category][]', $categories, null, array('class' => 'form-control select2-tags-category', 'multiple' => true)) !!}
			            								</div>
				            						</div>
				            						<div class="row filters-row">
				            							<div class="col-xs-12">
				            								{!! Form::select('fee-info[0][channel][]', Session::has('channels') ? Session::get('channels') : array(), null, array('class' => 'form-control select2-tags-channel', 'multiple' => true)) !!}
				            							</div>
				            						</div>
				            						<div class="row filters-row">
				            							<div class="col-xs-12">
				            								{!! Form::select('fee-info[0][product][]', Session::has('products') ? Session::get('products') : array(), null, array('class' => 'form-control select2-tags-product', 'multiple' => true)) !!}
				            							</div>
				            						</div>
						            				<div class="row">
						            					<div class="col-xs-12">
					            			...
					            			@else
					            				@foreach($old_inputs['fee-info'] as $index => $oldInput)
						            				<div class="contract-fee" data-index="{{$index}}" id="contract-fee-{{ $index }}">
					            						...
					            						<div class="row filters-row">
					            							<div class="col-xs-12">
					            								{!! Form::select('fee-info['.$index.'][channel][]', Session::has('channels') ? Session::get('channels') : array(), (isset($oldInput['channel'])) ? $oldInput['channel'] : null, array('class' => 'form-control select2-tags-channel', 'multiple' => true)) !!}
					            							</div>
					            						</div>
					            						<div class="row filters-row">
					            							<div class="col-xs-12">
		            		...
		            		<div class="col-xs-12">
				         		<div class="form-group pull-right">
					               <button type="button" id="btn_create_new_contract" class="btn btn-default">@lang('contracts.btn_create')</button>
					            </div> <!-- / .form-actions -->
					        </div>
	            		{!! Form::close() !!}
	            	</div>
				...
				<div class="modal-body">
					...
					<div class="box box-warning update-contract-date" id="update-date-{{ $dupContract->id }}">
						...
						<div class="box-footer clearfix">
							...
							<button type="button" data-url="{{ route('contract.updateDates', $dupContract->id) }}" data-index="{{ $dupContract->id }}" class="submit-update-date btn btn-success pull-right"><span class="pm-spinner"><i class="fa fa-circle-o-notch fa-spin fa-3x fa-fw"></i></span> Submit</button>
			            </div>
					</div>
					@endforeach
				</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
            ...
            if($(this).val() > 0){
            	...
            	if(selected.closest('optgroup').attr('label') == 'Inactive'){
            		if($(this).closest('.form-group').find('i').length == 0)
            			$(this).closest('.form-group').append('<i style="color: #f39c12; line-height: 35px;" data-toggle="tooltip" data-placement="right" title="Merchant is inactive" class="inactive-warning-icon fa fa-exclamation-triangle" aria-hidden="true"></i>');
            	}else{
		...
		$('#btn-add-new-rule').click(function(){
            var row = '\
            			<div class="contract-fee" data-index="'+rowIndex+'" id="contract-fee-'+rowIndex+'">\
    						...
    						<div class="row filters-row">\
    							<div class="col-xs-12">\
    								{!! Form::select('fee-info[rowIndex][channel][]', array(), null, array('class' => 'form-control select2-tags-channel', 'multiple' => true)) !!}\
    							</div>\
    						</div>\
    						<div class="row filters-row">\
    							<div class="col-xs-12">\
			...
			$("#contract-fee-"+rowIndex+" .select2-tags-channel").append(currentChannels);

			$("#contract-fee-"+rowIndex+" .select2-tags-product").append(currentProducts);

			$("#contract-fee-"+rowIndex+" .select2-tags-channel").select2({
				placeholder: '@lang('contracts.create_placeholder_fee_channel')'
			});
		...
		$('#btn_create_new_contract').on('click', function(){
			var errorFlag = false;
