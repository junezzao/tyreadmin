...
@section('title')
	@lang('admin/fulfillment.page_title_order_sheet', ['order_id' => $order->id])
@stop
	            		...
	            		<div class="col-xs-12">
							...
							<div class="row">
		            			<div class="col-xs-8">
		            				...
		            				<div class="form-group">
			            				<div class="bold col-xs-4"><strong>Status: </strong></div>
			            				<div class="col-xs-5">
			            					{{ $order->status }}
				            			</div>
			            			</div>
		            				<div class="form-group">
			            				<div class="bold col-xs-4"><strong>Paid Status: </strong></div>
			            					<div class="col-xs-5">
			            						{{ $order->paid_status }}
									   </div>
		            				</div>
		            				<div class="form-group">
			            				<div class="bold col-xs-4"><strong>Order Cancelled ? </strong></div>
			            					<div class="col-xs-5">
			            						{{ ($order->cancelled_status == false) ? 'No' : 'This order has been cancelled' }}
									   </div>
		            				</div>
		            			</div>
		            			<div class="col-xs-4">
