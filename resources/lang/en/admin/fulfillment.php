...
return [
    ...
    */
    ...
    'page_title_failed_orders'          => 'Admin - Failed Orders',
    ...
    'content_header_failed_orders'      => 'Failed Orders',
    ...
    'box_header_failed_orders'          => 'Failed Orders',
    ...
    'manual_order_form_help_cart_discount'                      => 'The cart discount amount given by third party. This amount is automatically calculated from the distributed amount per each individual item below.',
    ...
    'manual_order_form_help_amount_paid_total'                  => 'Amount paid should equal to sum of sold price for all items (inclusive of tax) and shipping fees (inclusive of tax, if any).',
    ...
    'manual_order_form_help_total_tax'                          => 'Total Tax amount is automatically calculated from the sum of tax amount per item below',
    ...
    'manual_order_form_label_promotion_code'                    => 'Promotion Code',
    ...
    'order_print_options_invoice'               => 'Invoice',
    ...
    'order_placeholder_search_order'            => 'Customer/Product/Hubwire SKU/Brand/Merchant',
    ...
    'manifest_btn_cancel'                       =>  'Cancel Manifest',
    ...
    /* Failed Orders */
    'failed_orders_table_tp_id'                 => 'Third Party Order ID',
    'failed_orders_table_channel'               => 'Channel',
    'failed_orders_table_pulled_date'           => 'Order Pulled Date',
    'failed_orders_table_error'                 => 'Error Details',
    'failed_orders_table_tp_date'               => 'Third Party Order Date',
    'failed_orders_table_resolved_by'           => 'Last Attended By',
    'failed_orders_table_actions'               => 'Actions',
    'failed_orders_table_status'                => 'Status',
    'failed_orders_table_order_id'              => 'Order ID',
];
